...
if __name__ == "__main__":
        ...
        for copula_name in COPULA_NAMES:
            for k_tau in K_TAU:
                for sample_cfg in DATA:
                    ...
                    # Load data
                    dl = SingleEventSyntheticDataLoader().load_data(data_cfg, k_tau=k_tau, copula_name="gaussian",
    ...
    filename = f"{cfg.RESULTS_DIR}/synthetic_results_wrong_copula_gauss.csv"
